...
public:
	...
	{
		// Если массив нужной длины - return
	...
	void remove(int index)
	{
		...
		// Если это последний элемент массива, то делаем массив пустым и return
		if (m_length == 1)
		{
			erase();
			return;
		...
		// Cоздаем новый массив на один элемент меньше старого массива
		Base *data = new Base[m_length - 1];
	...
	// Несколько дополнительный функций просто для удобства
